-- DRS World: Oval Racing System v5.4 (CRASH FIX)
-- Fixed nil trackLength crash | Robust telemetry | Error reporting

local VERSION = "OVAL v5.4"
...
function script.update(dt)
    ...
    local ok, err = pcall(function()
        ...
        -- FIX: Проверка на nil для trackLengthM
