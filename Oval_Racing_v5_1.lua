-- DRS World: Oval Racing System v5.1 (DEBUG VERSION)
-- Permanent version tag | Direct state trigger (No chat dependency for auto-yellow)

local VERSION = "OVAL v5.1"
            ...
            for i = 0, ac.getSim().carsCount - 1 do
                ...
                if car and car.isConnected and not car.isInPitlane and car.speedKmh < 40 then
                    ...
                    if slowTimers[i] > 2.0 then 
                        ...
                        -- 2. Активируем мгновенно у себя (не ждем чат)
...
function script.drawUI()
    -- ПОСТОЯННАЯ ВЕРСИЯ В УГЛУ
    ui.setCursor(vec2(10, 10))
    ui.textColored(VERSION, rgbm(1, 1, 1, 0.5))
